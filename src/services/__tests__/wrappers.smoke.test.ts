  ...
  it("returns null/false without tauri runtime", async () => {
    ...
    await expect(
      settingsSet({
        ...
        gateway_listen_mode: null,
        gateway_custom_listen_address: null,
        auto_start: false,
        tray_enabled: null,
        log_retention_days: 7,
        provider_cooldown_seconds: null,
        provider_base_url_ping_cache_ttl_seconds: null,
        upstream_first_byte_timeout_seconds: null,
        upstream_stream_idle_timeout_seconds: null,
        upstream_request_timeout_non_streaming_seconds: null,
        intercept_anthropic_warmup_requests: null,
        enable_thinking_signature_rectifier: null,
        enable_response_fixer: null,
        response_fixer_fix_encoding: null,
        response_fixer_fix_sse_format: null,
        response_fixer_fix_truncated_json: null,
        response_fixer_max_json_depth: null,
        response_fixer_max_fix_size: null,
        enable_circuit_breaker_notice: null,
        enable_codex_session_id_completion: null,
        circuit_breaker_failure_threshold: null,
        circuit_breaker_open_duration_minutes: null,
      } as any)
    ).resolves.toBeNull();
