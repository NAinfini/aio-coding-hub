...
impl GatewayErrorCode {
    pub(in crate::gateway) const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::InvalidForwardedPath => "GW_INVALID_FORWARDED_PATH",
            Self::RequestFieldsTooLarge => "GW_REQUEST_FIELDS_TOO_LARGE",
            ...
            Self::DnsResolutionFailed => "GW_DNS_RESOLUTION_FAILED",
            Self::ConnectionRefused => "GW_CONNECTION_REFUSED",
            Self::ConnectionTimeout => "GW_CONNECTION_TIMEOUT",
            Self::TlsError => "GW_TLS_ERROR",
            Self::AuthRejected => "GW_AUTH_REJECTED",
            Self::AllProvidersQuotaExceeded => "GW_ALL_PROVIDERS_QUOTA_EXCEEDED",
    ...
    pub(in crate::gateway) fn from_str(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "GW_INVALID_FORWARDED_PATH" => Self::InvalidForwardedPath,
            "GW_REQUEST_FIELDS_TOO_LARGE" => Self::RequestFieldsTooLarge,
            ...
            "GW_DNS_RESOLUTION_FAILED" => Self::DnsResolutionFailed,
            "GW_CONNECTION_REFUSED" => Self::ConnectionRefused,
            "GW_CONNECTION_TIMEOUT" => Self::ConnectionTimeout,
            "GW_TLS_ERROR" => Self::TlsError,
            "GW_AUTH_REJECTED" => Self::AuthRejected,
            "GW_ALL_PROVIDERS_QUOTA_EXCEEDED" => Self::AllProvidersQuotaExceeded,
